...
Student.prototype.scopeArrow = function(){ console.log(this);
...
//it was undefind so i fixed this problem and now we have result 
// 2. What is "this" when joe.scopeArrow() is invoked?
//it was undefind so i fixed this problem and now we have result 
// 3. Explain why "this" is different when an arrow function is used.
//When you call joe.scope(), the number of lives does not decrease. It is because this is not bound to anything, and will inherit the value of this from its parent scope.
